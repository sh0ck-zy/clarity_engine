...
PROMPTS = {
    ...
    # V4 - CALIBRATED (Draw-aware, lower confidence)
    "v4": {
        "name": "Calibrated (Draw-Aware, Realistic)",
        "text": load_prompt("v4_calibrated.txt")
    },
    # V6 - KNOW BALL (Psychology-first, game state reasoning)
    "v6": {
        "name": "Know Ball (Psychology + Game States)",
        "text": load_prompt("v6_know_ball.txt")
    }
}
